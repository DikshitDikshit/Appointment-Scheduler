...
public class AppointmentDialog {
	...
	private static final GridBagConstraints textConstants = new GridBagConstraints(
  	...
  	GridBagConstraints.EAST, 0, new Insets(2, 2, 2, 2), 1, 1); 
	...
	public static void showAppointmentDialog(Scheduler scheduler){
	    ...
	    saveButton.addActionListener(e -> {
	        ...
	        if (reply == JOptionPane.YES_OPTION) {
	            String activityType = (String) JOptionPane.showInputDialog(null, "Select",
	                    "Activity Type", JOptionPane.QUESTION_MESSAGE, null, 
	                    scheduler.getEmployee().getActivityType().toArray(), 
	                    scheduler.getEmployee().getActivityType().get(0)); 
